...
/* harmony import */ var _todo_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./todo.service */ "./src/app/todo.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_todo_service__WEBPACK_IMPORTED_MODULE_12__["TodoService"]],
...
var TodoService = /** @class */ (function () {
    ...
    TodoService.prototype.getTodoList = function () {
        return this._http.get(this.todoListUrl).map(function (response) {
            return response;
        });
    };
    TodoService.prototype.postTodoList = function (newTodo) {
...
var TodoComponent = /** @class */ (function () {
    ...
    TodoComponent.prototype.createTodo = function (newTodo) {
        var _this = this;
        this._todoService.postTodoList(this.newTodo)
            .subscribe(function (result) {
            _this.todoLists.push(result);
            _this.reset();
        });
    };
...
module.exports = __webpack_require__(/*! /home/tomix/Documents/Source/webapp/todo-app/src/main.ts */"./src/main.ts");
